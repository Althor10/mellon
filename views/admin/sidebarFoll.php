...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" id="sidebarMenu" data-widget="tree">
            ...
            <?php endif; ?>
            <li><a href="?page=admin"><i class="fa fa-link"></i> <span>Blog Posts</span></a></li>
            <li class="active"><a href="?page=admin&content=followers"><i class="fa fa-link"></i> <span>Followers</span></a></li>
            <li class="treeview">
